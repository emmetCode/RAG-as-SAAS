  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:8001/api/v1/company/register",
        {
          method: "POST",
          headers: {
      ...
      <div className="create-company-card">
        <div className="card-header">
          ...
          <p className="card-subtitle">
            Register your company to start managing your team
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="company-form">
          ...
          <div className="form-group">
            ...
            <p className="form-help-text">
              Enter email addresses separated by commas. Only users with these
              emails can join your company.
            </p>
          </div>
